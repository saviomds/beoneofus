          ...
          <div className="relative w-full max-w-2xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-[2rem] shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            <div className="p-6 sm:p-8 border-b border-gray-100 dark:border-gray-800 flex items-start justify-between bg-gray-50/50 dark:bg-gray-800/50">
              <div className="flex items-center gap-4">
                 ...
                 <div>
                   ...
                   <p className="text-sm font-bold text-gray-500 dark:text-gray-400">Instructed by <span className="text-blue-600 dark:text-blue-400 cursor-pointer hover:underline">{selectedCourse.author}</span></p>
                 </div>
              </div>
              <button onClick={() => setSelectedCourse(null)} className="p-2 text-gray-400 dark:text-gray-500 hover:text-gray-900 dark:hover:text-gray-100 bg-white dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full transition-colors border border-gray-200 dark:border-gray-700 shadow-sm">
                <X size={20} />
              </button>
            </div>
            <div className="p-6 sm:p-8">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8">
                You will be able to read actual production code from the network, run tests, and execute functions directly within the platform{`'`}s integrated environment.
              </p>
