...
export default function DocsPage() {
  ...
  type StatKey = "professionals" | "jobs" | "mentors" | "courses";
          ...
          <div className="max-w-[740px] mx-auto w-full">
            ...
            <section id="introduction" className="mb-16 scroll-mt-24">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
                {([
                  ...
                  { label: "Mentors",       key: "mentors"       as StatKey, color: "text-emerald-600 dark:text-emerald-400" },
                  { label: "Courses",       key: "courses"       as StatKey, color: "text-amber-600 dark:text-amber-400" },
                ] as const).map(s => (
            ...
            <div className="flex flex-wrap items-center justify-between pt-8 mt-4 border-t border-gray-200 dark:border-gray-800 gap-3">
              ...
              <div className="flex items-center gap-3">
                <Link href="/Academy" className="text-sm font-medium text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 transition-colors flex items-center gap-1.5">
