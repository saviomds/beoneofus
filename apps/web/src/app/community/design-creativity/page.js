...
const PLATFORM_FEATURES = [
  ...
  { icon: <Award size={16} />,         label: "Mentorship",       desc: "1-on-1 with senior designers",       href: "/dash/connections",          color: "blue"   },
...
const RESOURCES = [
  { title: "Design Systems Masterclass",    type: "Course",      link: "/resources",            icon: <BookOpen size={14} /> },
  { title: "UI Component Showcase",         type: "Projects",    link: "/Explore_Projects",   icon: <Layers size={14} />   },
  { title: "Brand Identity Templates",      type: "Resource",    link: "/resources",            icon: <Palette size={14} />  },
              ...
              <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl p-5">
                ...
                <div className="space-y-1.5">
                  {[
                    ...
                    { label: "Design Courses",       href: "/resources",                  icon: <BookOpen size={14} /> },
