...
const FEATURES = [
  ...
  },
  {
    ...
    label: "landing.features.mentorship.label",
    title: "landing.features.mentorship.title",
    desc: "landing.features.mentorship.desc",
    color: "from-emerald-500/10 to-emerald-600/5",
    border: "border-emerald-200 dark:border-emerald-800/40",
    icon_bg: "bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400",
    tag: "landing.features.mentorship.tag",
  ...
  },
  {
    ...
    label: "landing.features.courses.label",
    title: "landing.features.courses.title",
    desc: "landing.features.courses.desc",
    color: "from-amber-500/10 to-amber-600/5",
    border: "border-amber-200 dark:border-amber-800/40",
    icon_bg: "bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400",
    tag: "landing.features.courses.tag",
  ...
  {
    icon: <Award size={22} />,
    label: "landing.features.coaching.label",
    title: "landing.features.coaching.title",
    desc: "landing.features.coaching.desc",
    color: "from-rose-500/10 to-rose-600/5",
    border: "border-rose-200 dark:border-rose-800/40",
    icon_bg: "bg-rose-100 dark:bg-rose-900/30 text-rose-600 dark:text-rose-400",
    tag: "landing.features.coaching.tag",
...
const STEPS = [
  ...
  { n: "04", icon: <Bot size={20} />, title: "landing.how.grow.title", desc: "landing.how.grow.desc", color: "text-amber-600 dark:text-amber-400", bg: "bg-amber-500" },
];
...
const COMMUNITIES = [
  ...
  { name: "landing.community.education.name", icon: <GraduationCap size={20} />, desc: "landing.community.education.desc", color: "bg-violet-50 dark:bg-violet-900/20 text-violet-600 dark:text-violet-400" },
];

const FALLBACK_STATS = [
  { label: "landing.stats.professionals", value: 0, suffix: "" },
  { label: "landing.stats.jobs",   value: 0, suffix: "" },
  { label: "landing.stats.mentors",       value: 0, suffix: "" },
  { label: "landing.stats.courses",       value: 0, suffix: "" },
];
...
const TYPEWRITER_WORD_KEYS = [
  ...
  "landing.hero.typewriter.mentors",
  ...
  useEffect(() => {
    const fetchStats = async () => {
      ...
      setLiveStats([
        ...
        { label: "landing.stats.mentors", value: mentorCount ?? 0, suffix: "+" },
        { label: "landing.stats.courses", value: courseCount ?? 0, suffix: "+" },
      ]);
                  ...
                  <div className="grid grid-cols-4 gap-8">
                    <div className="col-span-2">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {[
                          { icon: <Bot size={17} />,          label: t('landing.nav.product_menu.ai_label'),    desc: t('landing.nav.product_menu.ai_desc'),    href: "/dash/ai",          color: "violet"  },
                          ...
                          { icon: <GraduationCap size={17} />,label: t('landing.nav.product_menu.mentorship_label'),      desc: t('landing.nav.product_menu.mentorship_desc'),    href: "/dash/mentorship",  color: "emerald" },
                          { icon: <BookOpen size={17} />,     label: t('landing.nav.product_menu.academy_label'),         desc: t('landing.nav.product_menu.academy_desc'),     href: "/Academy",          color: "amber"   },
                          ...
                          { icon: <Award size={17} />,        label: t('landing.nav.product_menu.coaching_label'),        desc: t('landing.nav.product_menu.coaching_desc'),      href: "/dash/coaching",    color: "rose"    },
                    ...
                    <div className="col-span-2">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {[
                          ...
                          { label: t('landing.nav.community_menu.hub_education'), href: "/community/education-research"  },
                        ].map(({ label, href }) => (
                          <Link key={label} href={href} onClick={() => setActiveDropdown(null)}
                ...
                {activeDropdown === "resources" && (
                  <div className="grid grid-cols-3 gap-10">
                    <div>
                      ...
                      {[
                        { icon: <BookOpen size={16} />, label: t('landing.nav.resources_menu.academy_label'),          desc: t('landing.nav.resources_menu.academy_desc'),            href: "/Academy"          },
                        { icon: <Award size={16} />,    label: t('landing.nav.resources_menu.certificates_label'),     desc: t('landing.nav.resources_menu.certificates_desc'),     href: "/dash/more"        },
              ...
              {[
                {
                  ...
                  links: [
                    { label: t('landing.nav.product_menu.ai_label'),    href: "/dash/ai"          },
                    { label: t('landing.nav.product_menu.jobs_label'), href: "/dash/services"    },
                    { label: t('landing.nav.product_menu.mentorship_label'),      href: "/dash/mentorship"  },
                    { label: t('landing.nav.product_menu.academy_label'),         href: "/Academy"          },
                    ...
                    { label: t('landing.nav.product_menu.coaching_label'),        href: "/dash/coaching"    },
                  ],
                },
                {
                ...
                },
                {
                  ...
                  links: [
                    ...
                    { label: t('landing.nav.resources_menu.academy_label'),       href: "/Academy"      },
        ...
        <section className="relative pt-28 sm:pt-36 pb-20 sm:pb-28 px-4 sm:px-6 overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none hidden xl:block" style={{ zIndex: 0 }}>
            ...
            <div className="animate-float2 absolute top-[35%] right-[5%] xl:right-[9%] animate-badge-pop" style={{ animationDelay: "1.5s" }}>
              <div className="flex items-center gap-2.5 bg-white/90 dark:bg-[#0f1723]/90 border border-violet-200 dark:border-violet-700/40 rounded-2xl shadow-xl px-3.5 py-2.5 backdrop-blur-sm max-w-[210px]">
                ...
                <div>
                  <p className="text-xs font-bold text-gray-900 dark:text-white">{t('landing.hero.badges.ai_title')}</p>
                  <p className="text-[11px] text-gray-500 dark:text-gray-400">{t('landing.hero.badges.ai_desc')}</p>
                </div>
              </div>
            </div>
            ...
            <div className="animate-float absolute bottom-[20%] right-[6%] xl:right-[11%] animate-badge-pop" style={{ animationDelay: "2.1s" }}>
              <div className="flex items-center gap-2.5 bg-white/90 dark:bg-[#0f1723]/90 border border-amber-200 dark:border-amber-700/40 rounded-2xl shadow-xl px-3.5 py-2.5 backdrop-blur-sm">
                ...
                <div>
                  <p className="text-xs font-bold text-gray-900 dark:text-white">{t('landing.hero.badges.mentor_title')}</p>
                  <p className="text-[11px] text-gray-500 dark:text-gray-400">{t('landing.hero.badges.mentor_desc')}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={`relative text-center max-w-4xl mx-auto transition-all duration-1000 ${heroVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ zIndex: 10 }}>
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-xs text-gray-500 dark:text-gray-500">
              {["landing.hero.trust.free", "landing.hero.trust.all_professions", "landing.hero.trust.no_spam", "landing.hero.trust.ai_powered", "landing.hero.trust.global"].map((key) => (
    ...
    <section ref={ref} className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
      ...
      <div className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 reveal ${visible ? "visible" : ""} reveal-delay-2`}>
        {[
          ...
          { icon: <Bot size={20} />, title: t('landing.what_is.cards.ai_title'), desc: t('landing.what_is.cards.ai_desc'), c: "text-violet-600 bg-violet-50 dark:bg-violet-900/20" },
          ...
          { icon: <BookOpen size={20} />, title: t('landing.what_is.cards.learn_title'), desc: t('landing.what_is.cards.learn_desc'), c: "text-amber-600 bg-amber-50 dark:bg-amber-900/20" },
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
          <div>
            ...
            <div className="grid grid-cols-2 gap-2.5 mt-6">
              {[
                "landing.premium.perks.mentors",
                "landing.premium.perks.ai",
                "landing.premium.perks.jobs",
                "landing.premium.perks.coaching",
...
function Footer({ session }) {
  ...
  const cols = [
    { title: t('landing.footer.platform_heading'), links: [
      ...
      { label: t('landing.footer.platform.mentorship'), href: authLink(session, "/dash/mentorship") },
      { label: t('landing.footer.platform.courses'), href: "/LearnPage" },
      { label: t('landing.footer.platform.coaching'), href: authLink(session, "/dash/coaching") },
    ]},
