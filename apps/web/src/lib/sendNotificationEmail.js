    ...
    return {
      ...
      html: baseShell(
        ...
        + `<tr><td style="padding:36px 40px;">
          ...
          ${ctaButton('Start Your Interview →', url + '/dash/jobs', '#2563eb')}
    ...
    return {
      ...
      html: baseShell(
        ...
        + `<tr><td style="padding:36px 40px;">
          ...
          ${ctaButton('Start Coding Challenge →', url + '/dash/jobs', '#7c3aed')}
        </td></tr></table>`
      ),
    };
  },
    ...
    return {
      ...
      html: baseShell(
        ...
        + `<tr><td style="padding:36px 40px;">
          ...
          ${ctaButton('View Full Results →', url + '/dash/jobs', scoreColor)}
        </td></tr></table>`
      ),
    };
  },
