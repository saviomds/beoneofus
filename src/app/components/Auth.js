    ...
    isCheckingAuth ? (
      <div className="w-full space-y-6 animate-pulse">
        <div className="flex gap-6 mb-8 border-b border-gray-200 dark:border-gray-800 pb-px">
          <div className="h-4 bg-gray-200 dark:bg-gray-800 rounded w-16 pb-3"></div>
          <div className="h-4 bg-gray-200 dark:bg-gray-800 rounded w-24 pb-3"></div>
        </div>
        <div className="space-y-5">
          ...
          <div className="h-12 bg-gray-200 dark:bg-gray-800 rounded-xl w-full mt-6"></div>
        </div>
      </div>
    ) : (
    <div className="w-full animate-in fade-in zoom-in-95 duration-500">
      {showSuccessCard ? (
        <div className="py-8 text-center space-y-4">
          ...
          <p className="text-2xl font-bold text-gray-900 dark:text-gray-100 tracking-tight">{successInfo.title}</p>
        ...
        <>
          ...
          {(view === 'sign-in' || view === 'sign-up') && (
            <div className="flex gap-6 mb-8 border-b border-gray-200 dark:border-gray-800 pb-px text-sm font-medium">
              <button type="button" onClick={() => setView('sign-in')} className={`pb-3 transition-all ${view === 'sign-in' ? 'text-blue-600 dark:text-blue-400 border-b-2 border-blue-600 dark:border-blue-400' : 'text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100'}`}>
                Sign In
              </button>
              <button type="button" onClick={() => setView('sign-up')} className={`pb-3 transition-all ${view === 'sign-up' ? 'text-blue-600 dark:text-blue-400 border-b-2 border-blue-600 dark:border-blue-400' : 'text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100'}`}>
                Create Account
              </button>
            </div>
          )}
            ...
            <>
              <div className="flex gap-4 mb-6">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl bg-[#24292F] dark:bg-white hover:bg-[#24292F]/90 dark:hover:bg-gray-200 text-white dark:text-gray-900 text-sm font-bold transition-all shadow-sm"
                >
              ...
              <div className="relative flex items-center gap-2 mb-6">
                ...
                <span className="text-[10px] uppercase font-black text-gray-400 dark:text-gray-500 tracking-widest">or continue with</span>
                <div className="flex-grow border-t border-gray-200 dark:border-gray-800"></div>
              </div>
            </>
          )}
          ...
          {view === 'forgot-password' && (
            <div className="mb-8">
              <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Reset Password</h2>
              <p className="text-sm text-gray-500 dark:text-gray-400">Enter your email address and we will send you a link to reset your password.</p>
            </div>
          )}

          {view === 'magic-link' && (
            <div className="mb-8">
              <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">Passwordless Sign-In</h2>
              <p className="text-sm text-gray-500 dark:text-gray-400">Enter your email address and we will send you a secure magic link to log in.</p>
            </div>
          )}
          ...
          {view === 'update-password' && (
            <div className="mb-8">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">Please enter your new password below.</p>
            </div>
          )}
          ...
          <form onSubmit={handleAuth} className="space-y-5">
            ...
            {view !== 'forgot-password' && view !== 'magic-link' && (
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  {view === 'sign-in' && (
                    <button type="button" onClick={() => setView('forgot-password')} className="text-xs font-bold text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors">
                      Forgot password?
                    </button>
                  )}
                </div>
            ...
            {view === 'sign-in' && (
              <div className="mt-4 text-center">
                <button type="button" onClick={() => setView('magic-link')} className="text-sm font-bold text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors">
            ...
            {(view === 'forgot-password' || view === 'magic-link') && (
              <button type="button" onClick={() => setView('sign-in')} className="w-full bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 py-3.5 rounded-xl font-bold transition-all border border-gray-200 dark:border-gray-700 mt-3 flex items-center justify-center gap-2">
                Back to Sign In
              </button>
            )}
          </form>
