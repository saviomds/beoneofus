...
const PLATFORM_FEATURES = [
  ...
  { icon: <Star size={18} />, label: "Mentorship", desc: "1:1 sessions with CFOs, analysts & investors", href: "/dash/connections", color: "violet" },
...
const RESOURCES = [
  { title: "Financial Modeling Masterclass", type: "Course", link: "/resources", icon: <BookOpen size={14} /> },
  { title: "Business Finance Fundamentals", type: "Course", link: "/resources", icon: <BarChart3 size={14} /> },
...
const QUICK_ACTIONS = [
  ...
  { label: "Book a Mentor", href: "/dash/connections", icon: <Star size={14} /> },
...
const OTHER_HUBS = [
  ...
  { label: "Education & Research", href: "/community" },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 text-sm text-gray-500 dark:text-gray-400">
              ...
              <Link href="/resources" className="hover:text-indigo-600 transition-colors font-medium">Academy</Link>
