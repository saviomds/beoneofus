...
export default function PagesContent() {
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto relative animate-in fade-in slide-in-from-bottom-4 duration-700">
      {activePage ? (
        <div className="w-full flex flex-col h-[calc(100vh-180px)] bg-white dark:bg-gray-900 rounded-[2rem] border border-gray-200 dark:border-gray-800 overflow-hidden relative animate-in fade-in zoom-in-95 duration-300 shadow-sm">
          {/* Header */}
          <div className="p-4 border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/50 flex items-center gap-3 z-10 shrink-0">
            <button onClick={() => setActivePage(null)} className="p-2 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-xl text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 transition">
              <ChevronLeft size={20} />
            </button>
            <div className="w-10 h-10 rounded-xl bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800/50 text-purple-600 dark:text-purple-400 flex items-center justify-center font-bold uppercase shrink-0">
              <LayoutTemplate size={20} />
            </div>
            <div>
              <h2 className="text-gray-900 dark:text-gray-100 font-bold text-lg leading-tight">{activePage.title}</h2>
              <p className="text-[10px] font-black tracking-widest text-purple-500 dark:text-purple-400 uppercase">Public Page</p>
            </div>
          </div>
                ...
                <div key={post.id} className="bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-800 rounded-2xl p-4 flex gap-3 animate-in fade-in slide-in-from-top-2 relative group">
                  ...
                  <div className="flex-1 min-w-0 pr-16">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-[9px] text-gray-500 dark:text-gray-400 uppercase tracking-widest shrink-0">
                    ...
                    {isEditing ? (
                      <div className="mt-2 animate-in fade-in">
                        <textarea
                          ...
                          className="w-full bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg p-2 text-sm text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 mb-2 resize-none"
                          rows={3}
                        />
                        <div className="flex gap-2">
                          ...
                          <button onClick={() => setEditingPostId(null)} className="bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-3 py-1.5 rounded-lg text-xs font-bold hover:bg-gray-300 dark:hover:bg-gray-600 transition">Cancel</button>
                        </div>
                      </div>
                    ) : (
          ...
          {/* Input */}
          <div className="p-3 bg-gray-50 dark:bg-gray-800/50 border-t border-gray-200 dark:border-gray-800 z-10 shrink-0">
            <form onSubmit={handleCreatePost} className="flex items-center gap-2 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-2xl p-1.5 pl-4 focus-within:ring-2 focus-within:ring-purple-500/20 focus-within:border-purple-500 transition-all shadow-sm">
              <input 
                type="text" 
                value={postInput} 
        ...
        <>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">Discover and manage public spaces.</p>
            </div>
            <button 
          ...
          {loading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="flex flex-col gap-2 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-5 shadow-sm">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-xl bg-gray-200 dark:bg-gray-800 animate-pulse shrink-0"></div>
            ...
            <div className="py-20 flex flex-col items-center justify-center border border-dashed border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 rounded-[2rem]">
              <FileText size={48} className="text-gray-400 dark:text-gray-500 mb-4" />
              <p className="text-gray-600 dark:text-gray-400 font-bold">No pages found.</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {pages.map((page) => (
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-md bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl shadow-xl overflow-hidden animate-in fade-in zoom-in duration-200">
            <div className="p-6 border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/50 flex justify-between items-center">
              <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">Create New Page</h2>
            ...
            <form className="p-6 space-y-5" onSubmit={handleCreatePage}>
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea rows={3} value={description} onChange={(e) => setDescription(e.target.value)} placeholder="What is this page about?" className="w-full bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-xl py-3 px-4 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all resize-none" />
                </div>
              </div>
