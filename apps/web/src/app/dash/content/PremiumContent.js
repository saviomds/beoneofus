...
const FEATURES = [
  ...
  { label: "Resume Builder",          free: true,  premium: true },
  { label: "Exclusive Job Listings",  free: false, premium: true },
  { label: "Advanced Profile Analytics", free: false, premium: true },
  { label: "Priority Network Access", free: false, premium: true },
  { label: "Early Event Access",      free: false, premium: true },
  { label: "Premium Profile Badge",   free: false, premium: true },
];

const PERKS = [
  { icon: Sparkles, title: "Exclusive Job Listings",  desc: "Premium-only roles and first access to new postings across every industry.",     color: "blue"    },
  { icon: Users,    title: "Priority Network Access",  desc: "Your connection requests and profile surface ahead of free members.",             color: "violet"  },
  ...
  { icon: Award,    title: "Advanced Analytics",       desc: "See who viewed your profile, search appearances, and post reach over time.",      color: "amber"   },
];
