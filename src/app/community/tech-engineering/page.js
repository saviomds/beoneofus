...
const PLATFORM_FEATURES = [
  ...
  { icon: <Award size={16} />, label: "Mentorship", desc: "1-on-1 with senior engineers", href: "/dash/mentorship", color: "violet" },
...
const INCOME_PATHS = [
  ...
  { title: "Technical Educator / Creator", range: "$50k–$300k/yr", note: "Courses, YouTube, paid newsletters", icon: <Play size={20} />, color: "amber", href: "/Academy" },
...
const RESOURCES = [
  { title: "Roadmap: Full-Stack Engineer 2025", type: "Guide", link: "/Academy", icon: <BookOpen size={14} /> },
  { title: "System Design Interview Prep", type: "Course", link: "/Academy", icon: <Layers size={14} /> },
              ...
              <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl p-5">
                ...
                <div className="space-y-1.5">
                  {[
                    ...
                    { label: "Take a Course",         href: "/Academy",                  icon: <BookOpen size={14} /> },
      ...
      <footer className="border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 py-8 mt-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {[{ l: "Community", h: "/community" }, { l: "Resources", h: "/resources" }, { l: "Academy", h: "/Academy" }, { l: "IDE", h: "/IDEPage" }, { l: "Projects", h: "/Explore_Projects" }, { l: "Blog", h: "/blog" }].map(({ l, h }) => (
