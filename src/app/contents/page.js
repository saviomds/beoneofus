...
const ITEMS = [
  {
    ...
    desc: 'AI-generated courses, interactive lessons, and real assessments tailored to your field and level.',
    icon: BookOpen,
    iconBg: 'bg-amber-500',
    ...
    tag: 'Self-paced',
    tagStyle: 'bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400',
    dest: '/dash/learn',
  },
  {
    id: 'pathways',
    label: 'Pathways',
    desc: 'Structured career roadmaps with AI gap analysis. Step-by-step progression toward your target role.',
    icon: Map,
    iconBg: 'bg-blue-600',
