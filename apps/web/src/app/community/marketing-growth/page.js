...
const PLATFORM_FEATURES = [
  ...
  { icon: <Star size={18} />, label: "Mentorship", desc: "1:1 sessions with senior marketers & CMOs", href: "/dash/connections", color: "violet" },
...
const RESOURCES = [
  { title: "Growth Marketing Foundations", type: "Course", link: "/resources", icon: <BookOpen size={14} /> },
  { title: "SEO & Content Strategy Guide", type: "Guide", link: "/resources", icon: <Search size={14} /> },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 text-sm text-gray-500 dark:text-gray-400">
              ...
              <Link href="/resources" className="hover:text-amber-600 transition-colors font-medium">Academy</Link>
