...
const DOC_SECTIONS = [
  {
    ...
    content: (
      <div className="space-y-4 text-gray-300 leading-relaxed text-sm">
        <p>
          <strong className="text-white">beoneofus</strong> is a highly interactive, developer-centric social networking and collaboration platform. Built with a specialized terminal aesthetic, it replaces standard terminology with technical paradigms.
        </p>
        <p>
        ...
        <div className="bg-blue-500/10 border border-blue-500/20 p-4 rounded-xl text-blue-400 mt-4">
    ...
    content: (
      <div className="space-y-4 text-gray-300 leading-relaxed text-sm">
        ...
        <ul className="list-disc list-inside space-y-2 ml-4 text-gray-400">
          <li><strong className="text-white">Username & Avatar:</strong> Customize how other nodes perceive you on the network.</li>
          <li><strong className="text-white">Node Status:</strong> A bio indicating your current system state (e.g., {`Active Node`}, {`In Maintenance`}).</li>
          <li><strong className="text-white">Security Clearance:</strong> Represents your verification level and registration data.</li>
        </ul>
      </div>
    )
  },
  {
    ...
    content: (
      <div className="space-y-4 text-gray-300 leading-relaxed text-sm">
        ...
        <div className="bg-red-500/10 border border-red-500/20 p-4 rounded-xl text-red-400 mt-4 shadow-[0_0_15px_rgba(239,68,68,0.1)]">
          ...
          <p className="text-xs mt-1 opacity-80">If a node becomes hostile, you can immediately <strong className="text-red-300">Sever the Connection</strong> (Block). This locks the channel and prevents future transmissions.</p>
        </div>
      </div>
    )
  },
      ...
      <div className="flex flex-col gap-6 flex-1 min-h-0">
        ...
        <div className="relative w-full shrink-0">
          <select
            ...
            className="w-full p-4 pr-12 rounded-2xl bg-[#0A0A0A] border border-white/10 text-white font-bold appearance-none focus:outline-none focus:border-blue-500/50 hover:border-white/20 transition-colors shadow-sm cursor-pointer"
          >
        ...
        {/* Main Content Area */}
        <div className="flex-1 bg-[#0A0A0A] border border-white/5 rounded-[2rem] relative overflow-hidden flex flex-col shadow-2xl">
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <div className="flex items-center gap-3">
                  ...
                  {activeSection.badge && (
                    <span className="bg-white/10 text-gray-300 text-[10px] font-black px-2 py-0.5 rounded uppercase tracking-widest border border-white/10">
                      {activeSection.badge}
                    </span>
                  )}
                </div>
