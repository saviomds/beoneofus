...
export async function POST(req) {
  try {
    ...
    const emailHtml = `
      ...
      <p>Your application for the role of <strong>${jobTitle}</strong> has been updated.</p>
      ${customMessage ? `<blockquote><strong>Message from team:</strong> "${customMessage}"</blockquote>` : ''}
